...
public class Main {
    ...
    static String[] getLocations() {
        String[] locations = new String[138];
        try (Scanner in = new Scanner(new FileInputStream("locations"))) {
            int i = 0;
    ...
    static String[] getPokemon() {
        ...
        try (Scanner in = new Scanner(new FileInputStream("pokemon"))) {
            int i = 0;
            while (in.hasNextLine()) {
                pokemon[i] = in.nextLine();
                i++;
            }
        } catch (IOException e) {
        }
